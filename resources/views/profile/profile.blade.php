...
>
  ...
  <body>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          src="{{ asset('template-admin/sneat-1.0.0') }}/assets/img/avatars/1.png"
                          alt="user-avatar"
    ...
    <!-- Page JS -->
    <script src="{{ asset('template-admin/sneat-1.0.0') }}/assets/js/pages-account-settings-account.js"></script>
